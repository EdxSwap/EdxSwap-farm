...
contract EDXswapCrowdsale is Ownable {
    using SafeMath for uint256;
    ...
    uint256 public constant CROWDSALE_START_TIME = 1617329015;
    
    //Minimum contribution is 0.1 BNB
    uint256 public  MIN_CONTRIBUTION = 100000000000000;
    
    //Maximum contribution is 100 BNB
    uint256 public  MAX_CONTRIBUTION = 100000000000000000000;
    ...
    constructor(
        ...
        timeOpen=CROWDSALE_START_TIME;
        timeClose=1619748215;
    }
    ...
    function purchaseEXDTokens() external payable {
          // Validations.
            require(
    ...
    function _buyTokens(address beneficiary, uint256 weiAmount) internal {
        ...
        EDXoken.safeTransfer(beneficiary, tokenAmount);
    ...
    function setTimeClose(uint256 time) public onlyOwner {
        timeClose=time;
    }
    ...
    function setLimit(uint256 min, uint256 max) public onlyOwner{
    ...
    function takeOutRemainingTokens() public onlyOwner {
        EDXoken.safeTransfer(msg.sender, EDXoken.balanceOf(address(this)));
    }
